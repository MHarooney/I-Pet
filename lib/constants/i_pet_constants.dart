...
class IPetConst {
  ...
  static const int REQUEST_CODE__DASHBOARD_SELECT_WHICH_USER_FRAGMENT = 2007;
  static const int REQUEST_CODE__DASHBOARD_SEARCH_FRAGMENT = 2006;
  ...
  static final NumberFormat iPetFormat = NumberFormat(IPetConfig.priceFormat);
